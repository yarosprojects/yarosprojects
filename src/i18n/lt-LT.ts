export default {
    ...
    section_in_mantainance: "Ši skiltis šiuo metu yra tvarkoma ir tobulinama. Atsiprašome už nepatogumus ir dėkojame už kantrybę.",
    ...
    intro: {
        ...
        hello_iam: "Sveiki, aš esu",
        fullstack_web_developer: "Fullstack žiniatinklio kūrėjas",
        years_of_experience: "metų patirtis",
        work_plus_personal_experience: "Darbas + Asmeninė",
        developer: "Kūrėjas",
        web_applications: "žiniatinklio programos",
        bioinformatical_profile: "profilis",
        bioinformatical: "bioinformatikas",
        from: "iš",
        focused_on: "Susitelkęs į",
        creation: "kūrimą",
        maintenance: "priežiūrą",
        resolution: "sprendimą",
        and: "ir",
        vulnerability: "pažeidžiamumus",
        of_static_and_dynamic_web_pages: "žiniatinklio puslapių",
        and_normal: "ir",
        of_normal: "",
        of_the: "",
        statics: "statinių",
    ...
    trajectory: {
        title: 'Karjera',
        actually: 'Šiuo metu...',
        intership_message: 'Praktikos sutartis',
        experiences: {
            'angular': {
                role: 'Frontend kūrėjas Angular',
                description: "Žiniatinklio sąsajų kūrimas su <strong>Angular</strong> ir našumo optimizavimas Barselonos provincijos kartografijos biure.",
            },
            'peon': {
                role: "Darbininkas",
                description: "Gamybos įrenginių priežiūra ir valymas.",
            },
            'peon-administrativo-desarollador': {
                role: "Darbininkas - Administratorius - Kūrėjas",
                description: `
                    <p>Gamybos įrenginių priežiūra ir valymas.</p>
                    <p>Sąskaitų registravimas, važtaraščių rengimas ir kitos administracinės bei biuro užduotys.</p>
                    <p>Be to, sukūriau <strong>įmonei skirtą žiniatinklio programą</strong>, skirtą klientų užsakymų valdymui, pagreitinant registravimą ir stebėjimą, gerinant veiklos efektyvumą ir suteikiant sklandesnę patirtį tiek klientams, tiek valdymo komandai.</p>
                `,
            },
        },
    },
    ...
    projects: {
        ...
        calculator: {
            name: 'Skaičiuotuvas',
            paragraph_1: "Skaičiuotuvas, atliekantis visas operacijas '+', '-', '*' ir '/'.",
            paragraph_2: "Taip pat apima papildomas funkcijas: šaknis ir procentus.",
        },
        tetris: {
            name: 'Tetris',
            paragraph_1: "Klasikinis Tetris žaidimas, sukurtas su Svelte.",
            paragraph_2: "Apima mobilius ir klaviatūros valdiklius, taškų sistemą ir progresuojančius lygius.",
        },
        snake: {
            name: 'Gyvatės žaidimas',
            paragraph_1: "Klasikinis gyvatės žaidimas, sukurtas su Vite ir Svelte.",
            paragraph_2: "Apima mobilius ir klaviatūros valdiklius, realaus laiko taškus ir didėjantį sudėtingumą ilgėjant gyvatei.",
        },
        joanolive: {
            name: 'Joan Olivé užsakymai',
            paragraph_1: "Profesionali žiniatinklio platforma, sukurta Joan Olivé, S.L., leidžianti klientams greitai, saugiai ir 24/7 pateikti užsakymus internetu.",
            paragraph_2: "Be to, valdymo komanda gali realiu laiku stebėti užsakymus, atnaujinti jų būseną, redaguoti, ištrinti ir efektyviai valdyti visą procesą iš vienos sąsajos.",
        },
    ...
    about_me: {
        ...
        and: 'ir',
        and_ua: '',
        graduated_in: 'specialistas',
        web_develpemn_specialist: 'žiniatinklio kūrime',
        with_experience_left: 'su patirtimi įvairiose programavimo kalbose',
        with_experience_right: 'ir kitose technologijose',
        i_like_create: 'Man patinka kurti projektus',
        innovative: 'inovatyvius',
        projects: '',
        combine: 'kurie sujungia',
        functionality: 'funkcionalumą',
        design: 'dizainą',
        exploring_to: 'tyrinėjant nuo žiniatinklio programų iki',
        creative_experiments: 'kūrybinių eksperimentų',
        every_project_is: 'Kiekvienas projektas yra',
    ...
    footer: {
        web_developer: "Žiniatinklio kūrėjas",
        apasionated: "aistringas",
        programming: "programavimui",
        and: "ir",
        web_pages_creation: "tinklalapių kūrimui",
        ensure_quality_for_clients: "užtikrinti kokybę klientams",
    },
    ...
    404: {
        ...
        opps: 'Ups!',
        had_trouble: 'Nepavyko rasti prašomo puslapio',
        consider_is_error: 'Manote, kad tai klaida?',
        contact_me: 'Susisiekite su manimi',
    },

    temporary_text: `Esu Yaroslav Klymko, baigęs žiniatinklio kūrimą, turintis patirties įvairiose
        programavimo kalbose ir technologijose. Man patinka kurti inovatyvius projektus,
        kurie sujungia funkcionalumą ir dizainą – nuo žiniatinklio programų iki kūrybinių eksperimentų.
        Kiekvienas projektas yra galimybė mokytis, tobulėti ir dalintis savo aistra programavimui su bendruomene.
    `,
}